class Tabs {
  ...
  init() {
    ...
    this.tabsBtns[0].classList.add('tabs__button--active');
  ...
  switchTabs(newTab, oldTab = this.tabs.querySelector('[aria-selected]')) {
    ...
    this.tabsBtns[oldIndex].classList.remove('tabs__button--active');
    this.tabsBtns[index].classList.add('tabs__button--active');
